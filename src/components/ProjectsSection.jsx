...
const projects = [
    {
        ...
        description: "An ongoing capstone project made for the Department of Environment and Natural Resources - Cordillera Administrative Region (DENR-CAR) to redesign their current website using Figma.",
        imageUrl: "/projects/capstoneUI.png",
        tags: ["Figma", "React", "Tailwind CSS"],
        demoUrl: "https://www.figma.com/design/90bH6EIqjfzJlrroe7Hq1n/IT-PROJECT-Prototype?node-id=0-1&p=f&t=sMuJoVTuPskUnmFX-0",
        githubUrl: "https://github.com/yukiroow/cordimap-landing-site",
        icons: [Figma, Github],
    },
    {
        id: 2,
    ...
    },
    {
        ...
        description: "In partial requirement of our Web Technologies (IT312) project, team KOTL developed a web site made with HTML and CSS for promoting UNESCO Sustainable Development Goal 14: Life Below Water and Goal 15: Life On Land. This UI shows the different problems, goals, projects, and innovations for both SDGs.",
        imageUrl: "/projects/alumaniaadminUI.png",
    ...
    },
    {
        ...
        description: "In partial requirement of our Web Technologies (IT312) project, team KOTL developed a web site made with HTML and CSS for promoting UNESCO Sustainable Development Goal 14: Life Below Water and Goal 15: Life On Land. This UI shows the different problems, goals, projects, and innovations for both SDGs.",
        imageUrl: "/projects/alumaniaalumniUI.png",
    ...
    },
    {
        ...
        imageUrl: "/projects/galleriamobileUI.png",
    ...
    },
    {
        ...
        description: "In partial requirement of our System Integration and Architecture (IT324) project, our team developed a UI for our proponent, Guidance Office. The UI is part of a system designed to help identify students who are at risk of failing, as well as professorts who have not yet submitted grades. This ensures that students receive timely academic assistance and that faculty members are guided in fulfilling their frading resposibilities.",
        imageUrl: "/projects/guidancehubUI.png",
        tags: ["Figma"],
    ...
    },
    {
        ...
        imageUrl: "/projects/malayahUI.png",
        tags: ["Figma", "Mobile UI"],
    ...
    },
    {
        ...
        imageUrl: "/projects/plugngoUI.png",
        tags: ["Figma"],
    ...
    },
    {
        ...
        imageUrl: "/projects/galleriaUI.png",
        tags: ["Figma"],
